...
public final class ExtentLogger {
    ...
    public static void logRequest(RequestSpecification requestSpecification, String fullUrl, String requestBody) {
    ...
    private static void logHeaders(QueryableRequestSpecification query) {
        if (query.getHeaders() != null && !query.getHeaders().asList().isEmpty()) {
            ...
            query.getHeaders().asList().forEach(header -> {
                headersJson.append("  \"").append(header.getName()).append("\": \"")
