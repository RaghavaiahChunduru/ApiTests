...
import com.example.annotations.DisabledTest;

/**
 * These tests are for demo purpose only (and to show the challenges that comes
 * with relying only on
 * RestAssured for writing tests. Do not use this as reference to design your
 * tests.
 */

class DoNotUseRestAssuredOnlyTests {
    // Given_When_Then
    @DisabledTest
