...
public class TestSandBox {
    ...
    void assertThatWeCanGetUserConfig() {
        ...
        assertThat(CONFIG.getBoolean("TOGGLE"))
                .as("TOGGLE should be false")
                .isFalse();

        assertThat(CONFIG.getInt("NUM_OF_USERS"))
                .as("NUM_OF_USERS should be 10")
                .isEqualTo(10);

        assertThat(CONFIG.getDouble("PRICE"))
                .as("PRICE should be 123.456")
                .isEqualTo(123.456);
