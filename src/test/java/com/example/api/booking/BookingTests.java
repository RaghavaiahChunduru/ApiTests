...
public class BookingTests {
    ...
    class AdminUser {
        ...
        void assertThatAUserCanPartiallyUpdateAnExistingBooking() {
            ...
            Booking partialBooking = Booking.builder()
                    .setFirstname("Raghavaiah")
                    .setLastname("Chunduru")
                    .build();
            ...
            // Assert
            Booking expectedBooking = booking.get()
    ...
    class GuestUser {
        ...
        void assertThatAUserCanNotUpdateAnExistingBookingWithoutValidAuthentication() {
            ...
            // Act
            Response response = BookingAPI.useAs(GUEST).updateBooking(unauthorizedBooking, bookingId.get());
            ExtentLogger.logResponse(response);

            // Assert
            VerifyBookingResponse.assertThat(response)
                    .statusCodeIs(SC_FORBIDDEN)
                    .assertAll();
        }
    }
}